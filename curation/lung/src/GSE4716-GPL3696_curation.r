...
uncurated <- read.csv("../uncurated/GSE4716-GPL3696_full_pdata.csv", as.is=TRUE,row.names=1)
celfile.dir <- "../../../DATA/GSE4716-GPL3696/RAW"
...
write.table(curated, row.names = FALSE, file="../curated/GSE4716-GPL3696_curated_pdata.txt",sep="\t")
