...
uncurated <- read.csv("../uncurated/GSE19915-GPL5186_full_pdata.csv",as.is=TRUE,row.names=1)
celfile.dir <- "../../../DATA/GSE19915-GPL5186/RAW"
...
write.table(curated, row.names=FALSE, file="../curated/GSE19915-GPL5186_curated_pdata.txt",sep="\t")
