...
uncurated <- read.csv("../uncurated/GSE6919-GPL93_full_pdata.csv",as.is=TRUE,row.names=1)
...
#tmp2 <- edit(curated) 
write.table(curated, row.names=FALSE, file="../curated/GSE6919-GPL93_curated_pdata.txt",sep="\t")
