...
uncurated <- read.csv("../uncurated/GSE21032-GPL5188_full_pdata.csv",as.is=TRUE,row.names=1)
...
#tmp2 <- edit(curated) 
write.table(curated, row.names=FALSE, file="../curated/GSE21032-GPL5188_curated_pdata.txt",sep="\t")
