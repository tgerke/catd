...
uncurated <- read.csv("../uncurated/GSE21032-GPL10264_full_pdata.csv",as.is=TRUE,row.names=1)
...
#tmp2 <- edit(curated) 
write.table(curated, row.names=FALSE, file="../curated/GSE21032-GPL10264_curated_pdata.txt",sep="\t")
