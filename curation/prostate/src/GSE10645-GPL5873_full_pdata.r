...
uncurated1 <- read.csv("../uncurated/GSE10645-GPL5873_series_matrix-1.txt.gz_full_pdata.csv",as.is=TRUE,row.names=1)
uncurated2 <- read.csv("../uncurated/GSE10645-GPL5873_series_matrix-2.txt.gz_full_pdata.csv",as.is=TRUE,row.names=1)
uncurated3 <- read.csv("../uncurated/GSE10645-GPL5873_series_matrix-3.txt.gz_full_pdata.csv",as.is=TRUE,row.names=1)
...
#tmp2 <- edit(curated) 
write.table(curated, row.names=FALSE, file="../curated/GSE10645-GPL5873_curated_pdata.txt",sep="\t")
