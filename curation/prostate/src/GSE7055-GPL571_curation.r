...
uncurated <- read.csv("../uncurated/GSE7055-GPL571_full_pdata.csv",as.is=TRUE,row.names=1)
...
#tmp2 <- edit(curated) 
write.table(curated, row.names=FALSE, file="../curated/GSE7055-GPL571_curated_pdata.txt",sep="\t")
