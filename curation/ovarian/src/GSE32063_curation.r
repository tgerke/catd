rm(list=ls())
uncurated <- read.csv("../uncurated/GSE32063_full_pdata.csv",as.is=TRUE,row.names=1)
source("../../functions.R")
...
write.table(curated, row.names = FALSE, file="../curated/GSE32063_curated_pdata.txt",sep="\t")
