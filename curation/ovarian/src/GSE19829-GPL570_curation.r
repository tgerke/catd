...
uncurated <- read.csv("../uncurated/GSE19829-GPL570_full_pdata.csv",as.is=TRUE,row.names=1)
celfile.dir <- "../../../DATA/GSE19829-GPL570/RAW"
...
write.table(curated, row.names=FALSE, file="../curated/GSE19829-GPL570_curated_pdata.txt",sep="\t")
